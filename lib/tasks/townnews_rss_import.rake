...
namespace :townnews do
    ...
    task :rss_import => :environment do
        ...
        def import_files
            ...
            url = 'https://www.bendbulletin.com/search/?q="Cami Sue Meade"&t=article&l=100&s=start_time&sd=desc&d='+find_date+'&c=&nk=%23tncen&fulltext=alltext&f=rss&altf=archive'
            ...
            item_tags.each do |item|
                ...
                story.copy = item["description"].truncate(65500).mb_chars.normalize(:kd).gsub(/[^\x00-\x7F]/n,'') unless item["description"].nil?
